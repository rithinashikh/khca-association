        ...
        <form id='addRegistrar' onSubmit={formik.handleSubmit}>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3">
              ...
              <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="type" type="text" placeholder="enter phone number..." name='email' value={formik.values.email} onChange={formik.handleChange} />
            </div>
          </div>
          {/* <div className="flex flex-wrap -mx-3 mb-6">
